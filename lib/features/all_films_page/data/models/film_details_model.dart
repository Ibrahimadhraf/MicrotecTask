...
FilmsDetailsModel filmsDetailsModelFromJson(String str) => FilmsDetailsModel.fromJson(json.decode(str));

String filmsDetailsModelToJson(FilmsDetailsModel data) => json.encode(data.toJson());

class FilmsDetailsModel {
  bool? adult;
  String? backdropPath;
  ...
  factory FilmsDetailsModel.fromJson(Map<String, dynamic> json) => FilmsDetailsModel(
    adult: json["adult"],
